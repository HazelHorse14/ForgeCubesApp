...
class ThemeModel with ChangeNotifier {
  ...
  bool get shouldUseMarkdownFlutterView {
    ...
    // https://github.com/forgecubes/forgecubes/issues/132
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  bottom: BorderSide(color: palette.grayBackground, width: 0.0),
                ),
              ),
              child: Row(
            ...
            Container(
              ...
              child: CupertinoPicker(
                ...
                scrollController: FixedExtentScrollController(
                  initialItem: groupItem.items.toList().indexWhere(
                    (v) => v.value == groupItem.value,
                  ),
                ),
