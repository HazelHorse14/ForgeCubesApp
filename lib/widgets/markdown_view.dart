...
import 'package:forgecubes/widgets/html_view.dart';
...
class MarkdownFlutterView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _hStyle = _basicStyle.copyWith(
      ...
      child: MarkdownBody(
        ...
        styleSheet: MarkdownStyleSheet(
          ...
          blockquoteDecoration: BoxDecoration(
            border: Border(
              left: BorderSide(color: Color(0xffdfe2e5), width: 4),
            ),
          ),
          ...
          horizontalRuleDecoration: BoxDecoration(
            border: Border(
              top: BorderSide(width: 4, color: theme.palette.grayBackground),
            ),
          ),
        ),
