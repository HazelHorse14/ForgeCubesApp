...
class GhBioWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isNotNullOrEmpty(p.location)) {
      return Row(
        children: <Widget>[
          Icon(Octicons.location, size: 15, color: theme.palette.secondaryText),
          SizedBox(width: 4),
    ...
    return Row(
      children: <Widget>[
        Icon(Octicons.clock, size: 15, color: theme.palette.secondaryText),
        SizedBox(width: 4),
        Expanded(
          child: Text(
            'Joined on ${dateFormat.format(p.createdAt)}',
