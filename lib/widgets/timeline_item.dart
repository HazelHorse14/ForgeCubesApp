...
class TimelineItem extends StatelessWidget {
  ...
  Widget _buildFallback(String? type) {
    return TimelineEventItem(
      ...
      textSpan: TextSpan(
        children: [TextSpan(text: 'Woops, $type type not implemented yet')],
      ),
    );
  }
    ...
    switch (type) {
      ...
      case 'IssueComment':
        return CommentItem.gql(
          node as GCommentParts,
          node as GReactableParts,
          (item) {},
        );
      ...
      case 'LockedEvent':
        ...
        return TimelineEventItem(
          ...
          textSpan: TextSpan(
            children: [TextSpan(text: ' locked this conversation ')],
          ),
        );
      case 'UnlockedEvent':
        ...
        return TimelineEventItem(
          ...
          iconData: Octicons.key,
          textSpan: TextSpan(
            children: [TextSpan(text: ' unlocked this conversation ')],
          ),
        );
      ...
      case 'DeploymentEnvironmentChangedEvent':
        ...
        return TimelineEventItem(
          ...
          textSpan: TextSpan(
            text:
                ' changed the deployment environment to ' +
      ...
      case 'ReviewDismissedEvent':
        ...
        return TimelineEventItem(
          ...
          textSpan: TextSpan(
            children: [
              TextSpan(
                text: ' dismissed the pull request review requested by ',
              ),
