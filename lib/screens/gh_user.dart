...
import 'package:forgecubes/widgets/contribution.dart';
import 'package:forgecubes/widgets/mutation_button.dart';
import 'package:forgecubes/widgets/entry_item.dart';
import 'package:forgecubes/widgets/repository_item.dart';
import 'package:forgecubes/widgets/table_view.dart';
import 'package:forgecubes/widgets/text_with_at.dart';
        ...
        ContributionWidget(
          weeks: [
            for (final week
              ...
              [
                //  https://github.com/forgecubes/forgecubes/issues/122
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshStatefulScaffold<GUserParts?>(
      fetch: () async {
        ...
        final OperationResponse<GViewerData, GViewerVars?> res = await auth
            .gqlClient
            .request(req)
            .first;
      ...
      action: ActionEntry(iconData: Ionicons.cog, url: '/settings'),
      bodyBuilder: (p, _) {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshStatefulScaffold<GUserData?>(
      fetch: () async {
        ...
        final OperationResponse<GUserData, GUserVars?> res = await auth
            .gqlClient
            .request(req)
            .first;
        return res.data;
