...
import 'package:forgecubes/widgets/markdown_view.dart';
import 'package:forgecubes/widgets/language_bar.dart';
import 'package:forgecubes/widgets/repo_header.dart';
  ...
  Widget build(BuildContext context) {
    ...
    >(
      ...
      fetch: () async {
        ...
        final p = await auth.fetchGitlab('/projects/$id?statistics=1').then((
          res,
        ) {
          return GitlabProject.fromJson(res);
        });

        final langFuture = auth.fetchGitlab('/projects/$id/languages').then((
          v,
        ) {
      ...
      actionBuilder: (t, _) {
        return ActionButton(
          ...
          items: [...ActionItem.getUrlActions(t.item1.webUrl)],
        );
      },
      bodyBuilder: (t, _) {
        final p = t.item1;
          ...
          children: <Widget>[
            ...
            FutureBuilder<Map<String, double>>(
              ...
              builder: (context, snapshot) {
                ...
                if (data == null) {
                  return LanguageBar([LanguageBarItem(name: '', ratio: 1)]);
                } else {
                  return LanguageBar([
