...
import 'package:forgecubes/widgets/error_reload.dart';
import 'package:forgecubes/widgets/loading.dart';
import 'package:forgecubes/widgets/empty.dart';
export 'package:forgecubes/utils/utils.dart';
...
class _ListStatefulScaffoldState<T, K>
  ...
  Widget _buildBody() {
    switch (Provider.of<ThemeModel>(context).theme) {
      ...
      default:
        return RefreshIndicator(onRefresh: _refresh, child: _buildMaterial());
    }
  }
