...
import 'package:forgecubes/scaffolds/utils.dart';
...
class _RefreshStatefulScaffoldState<T>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.canRefresh) {
      child = RefreshWrapper(onRefresh: _refresh, body: child);
    }

    return CommonScaffold(title: widget.title, body: child, action: _action);
  }
}
